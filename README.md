...
<div style="display: flex; flex-wrap: no-wrap; width: 100%; gap: 16px">
    ...
    <img width="15%" class='poke-img' src='https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/585.svg' alt='deerling'/>
</div>

<span class="poke-name"> Pokemon Name : fuecoco</span>
